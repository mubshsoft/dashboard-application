...
const items = [
  { label: 'Profile', key: '1' },
  { label: 'My Account', key: '2' },
  { label: 'Change Password', key: '3' },
];

const UserProfile = () => (
  <div className="flex items-center gap-1">
    <img src="https://demos.creative-tim.com/notus-js/assets/img/team-1-800x800.jpg" className="w-[30px] rounded-full" alt="User Avatar" />
    <div className='flex items-center justify-between p-4 h-5 gap-4'><span>Jhontosan </span><RiArrowDownSLine /></div>
  </div>
);
...
const Header = () => (
  <header className="flex flex-col md:flex-row gap-4 items-center justify-between p-4 w-full">
    <div className="flex items-center gap-4">
      <img src="https://demos.creative-tim.com/notus-js/assets/img/team-1-800x800.jpg" alt="User" className="w-10 h-10 rounded-full border-2 border-blueGray-50 shadow" />
    ...
    <form className="w-full md:w-[40%] lg:w-[20%] order-1 md:order-none hidden lg:block">
    ...
    <nav className="w-full md:w-[30%] flex justify-center md:justify-end">
      <ul className="flex items-center gap-4">
        ...
        <Dropdown menu={{ items, onClick }}>
          <li className="shadow-lg px-4 py-1 rounded-full">
